    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="${pageContext.request.contextPath}/admin/addQuiz">Create New Quiz</a>
                <a class="collapse-item" href="${pageContext.request.contextPath}/admin/quizList">Quiz List</a>
            </div>
        </div>
    </li>
